 ...
 *
 */
public class TrapezoidForwardBoilerPeg extends Command {

	private TrapezoidProfile traj;
	
    public TrapezoidForwardBoilerPeg() {
    	requires(Robot.InstanceMap.driveTrain);
    	traj = new TrapezoidProfile(DriveTrain.tCfg, 108.125 - DriveTrain.d_center_from_back);
    }
