 ...
 *
 */
public class TrapezoidToBoilerPeg extends Command {

	private TrapezoidProfile traj;
	
    public TrapezoidToBoilerPeg() {
    	requires(Robot.InstanceMap.driveTrain);
    	traj = new TrapezoidProfile(DriveTrain.tCfg, 82.8498-(40-DriveTrain.d_center_from_back));
    }
