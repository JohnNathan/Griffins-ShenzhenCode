 ...
 *
 */
public class TrapezoidToRetzonePeg extends Command {

	private TrapezoidProfile traj;
	
    public TrapezoidToRetzonePeg() {
    	requires(Robot.InstanceMap.driveTrain);
    	traj = new TrapezoidProfile(DriveTrain.tCfg, 120.955 - (40-DriveTrain.d_center_from_back));
    }
